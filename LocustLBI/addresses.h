...
#define appendarray_CCV __thiscall
	...
	* atomic_Decompiled_Args: int a1
	* atomic_TypeDef: int
	* atomic_Aob: Unable to generate aob.
	* atomic_ProtectedByRetcheck: false
	* atomic_IsApartOfLua: true
	* atomic_Mask: ....
	* Usage (Not 100% Accurate):
	...
	* (Compatable Format) Usage (Not 100% Accurate):
	...
	using r_atomic_typedef = int(atomic_CCV*)(int a1);
	r_atomic_typedef r_atomic = (r_atomic_typedef)(x(Adresses::atomic_addr));
...
#define calltmres_CCV __cdecl
	...
	* cleartable_Decompiled_Args: int a1
	* cleartable_TypeDef: int
	* cleartable_Aob: Unable to generate aob.
	* cleartable_ProtectedByRetcheck: false
	* cleartable_IsApartOfLua: true
	* cleartable_Mask: ....
	* Usage (Not 100% Accurate):
	...
	* (Compatable Format) Usage (Not 100% Accurate):
	...
	using r_cleartable_typedef = int(cleartable_CCV*)(int a1);
	r_cleartable_typedef r_cleartable = (r_cleartable_typedef)(x(Adresses::cleartable_addr));
